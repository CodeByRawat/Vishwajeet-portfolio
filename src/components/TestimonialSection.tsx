...
export default function TestimonialSection() {
  return (
    <section className="py-24 bg-[var(--bg-dark)] relative overflow-hidden">
      <div className="absolute top-0 right-1/4 w-[500px] h-[500px] rounded-full blur-[120px] pointer-events-none" style={{ background: 'rgba(75,35,18,0.25)' }} />
      ...
      <div className="container mx-auto px-6 relative z-10 border-none">
        <div className="text-center mb-16">
          ...
          <ScrollReveal direction="up" delay={0.1}>
            <h2 className="text-4xl lg:text-5xl font-[family-name:var(--font-outfit)] font-light text-white mt-4">
